...
import { BucketDialogComponent } from '../../../../../../main/webapp/app/entities/bucket/bucket-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Bucket Management Dialog Component', () => {
        let comp: BucketDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(BucketDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'bucketListModification', content: 'OK'});
